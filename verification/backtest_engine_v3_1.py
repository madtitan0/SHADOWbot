...
class Config:
    ...
    RISK_PERCENT = 0.010 # INCREASED TO 1.0%
    ...
    USE_PULLBACK = True
    USE_HTF_FILTER = True 
    USE_EXTREME_RSI = True # NEW: Allow Extreme RSI Override
...
class Backtester:
    ...
    def generate_report(self):
        ...
        print("\n--- 2024-2025 MONTHLY BREAKDOWN (V3.1 PROFIT TUNED) ---")
        ...
        # Save Report
        with open("backtest_report_v3_1.md", "w") as f:
            f.write("# PropBot V3.1 (Profit Maximized) Report\n\n")
            f.write("## Config\n")
            f.write("- **Strategy**: V3.1 (Risk 1.0% + Extreme RSI Override)\n")
